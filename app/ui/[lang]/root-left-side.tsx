...
const linkToSvgMap: { [key: string]: ReactElement } = {
  email: (
    <EmailIcon className="w-[24px] h-[24px] hover:scale-105 hover:text-accent transition-all ease-in-out duration-300" />
  ),
  github: (
    <GithubLogoIcon className="w-[24px] h-[24px] hover:scale-105 hover:text-accent transition-all ease-in-out duration-300" />
  ),
  linkedin: (
    <LinkedinLogoIcon className="w-[24px] h-[24px] hover:scale-105 hover:text-accent transition-all ease-in-out duration-300" />
  ),
};
